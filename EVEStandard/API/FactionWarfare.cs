...
namespace EVEStandard.API
{
    ...
    public class FactionWarfare : APIBase
    {
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/wars/");

            checkResponse("DataAboutFactionWarsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/stats/");

            checkResponse("StatsAboutFactionWarsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/systems/");

            checkResponse("FactionWarSystemOwnershipV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/leaderboards/");

            checkResponse("TopFactionsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/leaderboards/characters/");

            checkResponse("TopPilotsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        {
            var responseModel = await this.GetAsync("/v1/fw/leaderboards/corporations/");

            checkResponse("TopCorporationsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task<FactionWarCorporationStats> CorporationOverviewInFactionWarsV1Async(AuthDTO auth, long corporationId)
        {
            ...
            var responseModel = await this.GetAsync("/v1/corporations/" + corporationId + "/fw/stats/");

            checkResponse("CorporationOverviewInFactionWarsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task<FactionWarCharacterStats> CharacterOverviewInFactionWarsV1Async(AuthDTO auth)
        {
            ...
            var responseModel = await this.GetAsync("/v1/characters/" + auth.Character.CharacterID + "/fw/stats/");

            checkResponse("CharacterOverviewInFactionWarsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
