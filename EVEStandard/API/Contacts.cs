...
namespace EVEStandard.API
{
    ...
    public class Contacts : APIBase
    {
        ...
        public async Task DeleteContactsV2Async(AuthDTO auth, List<long> contactIds)
        {
            ...
            var responseModel = await this.DeleteAsync("/v2/characters/" + auth.Character.CharacterID + "/contacts/", auth, queryParameters);

            checkResponse("DeleteContactsV2Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        }
        ...
        public async Task<(List<Contact>, long)> GetContactsV1Async(AuthDTO auth, long page)
        {
            ...
            var responseModel = await this.GetAsync("/v1/characters/" + auth.Character.CharacterID + "/contacts/", auth);

            checkResponse("GetContactsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task<List<long>> AddContactsV1Async(AuthDTO auth, List<long> contactIds, long labelId, float standing, bool isWatched)
        {
            ...
            var responseModel = await this.PostAsync("/v1/characters/" + auth.Character.CharacterID + "/contacts/", auth, contactIds, queryParameters);

            checkResponse("AddContactsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task EditContactsV1Async(AuthDTO auth, List<long> contactIds, long labelId, float standing, bool isWatched)
        {
            ...
            var responseModel = await this.PutAsync("/v1/characters/" + auth.Character.CharacterID + "/contacts/", auth, contactIds, queryParameters);

            checkResponse("EditContactsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        }
        ...
        public async Task<(List<Contact>, long)> GetCorporationContactsV1Async(AuthDTO auth, long page, long corporationId)
        {
            ...
            var responseModel = await this.GetAsync("/v1/corporations/" + corporationId + "/contacts/", auth);

            checkResponse("GetCorporationContactsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task<(List<Contact>, long)> GetAllianceContactsV1Async(AuthDTO auth, long page, long allianceId)
        {
            ...
            var responseModel = await this.GetAsync("/v1/alliances/" + allianceId + "/contacts/", auth);

            checkResponse("GetAllianceContactsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
        ...
        public async Task<List<ContactLabel>> GetContactLabelsV1Async(AuthDTO auth)
        {
            ...
            checkResponse("GetContactLabelsV1Async", responseModel.Error, responseModel.LegacyWarning, this.Logger);
